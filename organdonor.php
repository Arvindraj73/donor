...
echo "<input type='hidden' value='$s' name='hidden'>"?>
  ...
  <div class="s"><label for="Organ">Organ:</label><br>
  <input type="text" id="Organ" name="Organ" placeholder="Enter your Organ name "><br></div>
  ...
  <input type="text" id="lname" name="Address" placeholder="Enter your address"><br><br></div>
