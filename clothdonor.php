...
echo "<input type='hidden' value='$s' name='hidden'>"?>
  ...
  <div class="s"><label for="Cloth Type">Cloth Type:</label><br>
  <input type="text" id="Blood group" name="ctype" placeholder="Enter Cloth Type "><br></div>

  <div class="s"><label for="Quantity">Quantity:</label><br>
  <input type="Number" id="Age" name="quan" placeholder="Enter Quantity"><br></div>
  ...
  <div class="s"><label for="Gender">Cloth For:</label><br>
  <select id="Gender" name="cfor">
  <option value="Children">Children</option>
  <option value="Adult">Adult</option>
  </select><br></div>

  <div class="s"><label for="Gender">Cloth for Gender:</label><br>
